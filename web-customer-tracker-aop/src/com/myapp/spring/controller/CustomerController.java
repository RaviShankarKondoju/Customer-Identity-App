...
public class CustomerController {
	...
	// ** UPDATE service layer is added so no need to inject customer dao

	// However inject service layer
	...
	// @GetMapping accepts only GET requests
	// @PostMapping accepts only POST requests

	@GetMapping("/list")
	public String listCustomers(Model theModel) {

		// get customers from the service which in turn delegates the call to DAO
